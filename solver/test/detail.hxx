...
TEST_CASE("detail::init_fill_array")
{
  SUBCASE("with a value")
  {
    ...
    const auto a2 = detail::init_fill_array<5>(42);
  ...
  SUBCASE("with a function")
  {
    ...
    const auto a2 = detail::init_fill_array<5>([](int i){ return i*i; });
...
TEST_CASE("detail::tpl_inner_product")
{
  ...
  const std::array<int,N+1> tab = detail::init_fill_array<N+1>([](int i){ return i; });
