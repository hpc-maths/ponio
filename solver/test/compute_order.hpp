...
auto mayor_method(Container const& x, Container const& y)
{
...
template <typename T = double>
auto relative_error(T u, T v)
{
    return std::abs((u - v) / u);
}

template <typename Algorithm_t, typename T = double>
auto solve_exp(Algorithm_t& algo, T dt, T Tf)
{
    using state_t = T;
...
template <typename Algorithm_t, typename T = double>
T short_time_check_order(Algorithm_t algo = Algorithm_t())
{
    using state_t = T;
...
template <typename Algorithm_t, typename T = double>
T long_time_check_order(Algorithm_t& algo)
{
...
template <typename Algorithm_t, typename T = double>
T check_order(Algorithm_t algo = Algorithm_t())
{
